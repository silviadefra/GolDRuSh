...
def main(binary, rules_file, file_type, num_values, num_best_fit, num_generations, len_cache, steps, tests=None):
    ...
    if tests is None:
        tests=[['jLvqPOgVf{{\x15\x15[|oonmO[>n~N}\x1f?=[{}\x04'], ['b5zVQVoe\x08b5z6A"XAA::::@6hh6``\x18\x0f\x0f3e\x18\x1d\x00fNi'], ['bzVQVoe\x08b5z6A"XAA::::@6hh6```\x0f\x0f3e\x18\x1d\x00(i'], ['-bQ7iirgkCQRTLhlY0MiWT5GBH8xrMMW8I'], ['fDj9GV1WBI9wDkkl[ll bY\x02Z"\x02Lu~HH__\x03GH'], ['rNl1cwBN6BB6jjljmLJ0Ewwj\x1c6SUyRSL\x0c']]
